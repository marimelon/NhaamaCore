...
using System.Text;
using NhaamaCore.Memory.Native;
using NhaamaCore.Memory.Native.Enums;
using NhaamaCore.Memory.Native.Structs;
...
namespace NhaamaCore.Memory
{
    public class NhaamaProcess
    {
		...
		/// <summary>
		/// Read a Boolean from the specified offset.
		/// </summary>
		/// <param name="offset">Offset to read from.</param>
		/// <returns>Read Boolean.</returns>
		public bool ReadBoolean(ulong offset) => BitConverter.ToBoolean(ReadBytes(offset, 4), 0);
		...
		/// <summary>
		/// Read a Int64 from the specified offset.
		/// </summary>
		/// <param name="offset">Offset to read from.</param>
		/// <returns>Read Int64.</returns>
		public long ReadInt64(ulong offset) => BitConverter.ToInt64(ReadBytes(offset, 8), 0);
		...
		public int ReadInt32(ulong offset) => BitConverter.ToInt32(ReadBytes(offset, 4), 0);

		/// <summary>
		/// Read a Int16 from the specified offset.
		/// </summary>
		/// <param name="offset">Offset to read from.</param>
		/// <returns>Read Int16.</returns>
		public short ReadInt16(ulong offset) => BitConverter.ToInt16(ReadBytes(offset, 2), 0);
		...
		/// <summary>
		/// Read a double from the specified offset.
		/// </summary>
		/// <param name="offset">Offset to read from.</param>
		/// <returns>Read Double.</returns>
		public double ReadDouble(ulong offset) => BitConverter.ToDouble(ReadBytes(offset, 8), 0);
